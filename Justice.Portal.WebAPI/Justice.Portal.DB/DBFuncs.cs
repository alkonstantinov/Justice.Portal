...
namespace Justice.Portal.DB
{
    ...
    public class DBFuncs
    {
        ...
        public string [] GetMinCareerJsons()
        {
            return db.Block.Where(x => x.BlockId == 20965 || x.BlockId == 20966 || x.BlockId == 20967 || x.BlockId == 21184)
                
                
                .Select(x => 
                x.Jsonvalues
                .Replace("\"type\":{\"bg\":\"Министерство на правосъдието\"", "\"type\":{\"bg\":\"Конкурси за държавен съдебен изпълнител, частен съдебен изпълнител, помощник-частен съдебен изпълнител, съдия по вписванията, нотариус, помощник-нотариус по заместване и синдик.\"")
                .Replace("\"type\":{\"bg\":\"\"", "\"type\":{\"bg\":\"Конкурси за избор на членове на органите за управление и контрол в публичните предприятия\""))
